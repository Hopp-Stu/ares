          ...
          <div class="left-wrapper-fixed">
            ...
            <div class="menu-wrapper">
              <ul>
                ...
                >
                  <i class="iconfont el-icon-house"></i>
                  <p>Home</p>
                </li>
                <li
                ...
                >
                  <i class="iconfont el-icon-collection-tag"></i>
                  <p>Tag</p>
                </li>
                <li class="">
                  <i class="iconfont el-icon-link"></i>
                  <p>Github</p>
                </li>
              </ul>
            </div>
      ...
      <div class="main-wrapper">
        <div class="nav-wrapper" :class="{ 'nav-shadow': navShadow }">
          ...
          <i
            ...
            style="padding: 20px 1px 1px 1px"
          ></i>
          <i
            class="iconfont el-icon-search search-i"
            style="padding: 20px 1px 1px 40px"
            :class="{ 'search-opacity': searchStatus }"
        ...
        <div class="footer">
          <div class="copyright">
            <p>ares©2020-2025 沪ICP备18012301号</p>
